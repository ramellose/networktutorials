...
To install FlashWeave, run the following commands in a Julia session. To enter the package installation mode (Pkg REPL), use **]**; note that is not necessary for the latest Julia version. 
To exit the Pkg REPL, use Backspace or Ctrl + C. 
