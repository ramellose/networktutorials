...
We are going to work on a phyloseq object that can be downloaded  [here](https://github.com/ramellose/networktutorials/tree/master/Workshop%20network%20analysis%202019). As WGCNA cannot work directly on phyloseq objects, let's extract the abundance table first. Keep in mind that WGCNA needs to have the taxa as columns. 
